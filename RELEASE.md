...
**Breaking change**: `PAGINATION_MAX_LIMIT` now defaults to `1000` instead of `None`, so clients can
no longer request more than 1000 rows in a single page by default.
