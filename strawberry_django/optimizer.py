...
def _get_hints_from_django_field(
    ...
    *,
    ...
    # If the field has a base resolver, don't try to optimize it by default. The user
    # should be defining custom hints in this case, which already get applied via
    # `_get_hints_from_field`. GlobalID and `can_optimize`-flagged resolvers are
