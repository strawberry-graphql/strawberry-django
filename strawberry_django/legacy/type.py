...
def type(model, *, fields=None, types=None, **kwargs):
    ...
    if "fields" in kwargs:
        utils.deprecated(
            "'fields' parameter is deprecated," " please define all fields in class",
            stacklevel=stacklevel,
        )
    if "types" in kwargs:
        utils.deprecated(
            "'types' parameter is deprecated," " please define all types in class",
            stacklevel=stacklevel,
        )
...
def input(model, *, fields=None, types=None, partial=False, **kwargs):
    ...
    return type(
        model, fields=fields, types=types, partial=partial, is_input=True, **kwargs
    )
